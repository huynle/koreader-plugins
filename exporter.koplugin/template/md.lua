...
local function prepareBookContent(book, formatting_options, highlight_formatting)
	...
	content = content .. "---\n"
	content = content .. "title: " .. book.title .. " - " .. book.author .. "\n"
	content = content .. "zk: literature\n"
	...
	for _, note in ipairs(book) do
		...
		if highlight_formatting then
			content = content
				.. string.format(formatters[formatting_options[entry.drawer]].formatter, entry.text)
				.. "\n"
		else
